...
```{r, fig.cap = "**Figure 1.** Total Number of\nBigfoot Sightings by County (1869-2023)",  warning=FALSE, message = FALSE,  fig.width=14, fig.height=10}
...
ggplot()  +
  geom_sf(data = conus_sf,
   ...
   geom_sf(data = counties_conus_sf,
            ...
            linewidth = 0.05,
            linetype = "solid") +
    geom_sf(data = bigfoot_summary_df,
           aes(fill = number_of_sightings),
          pch = 21,
          color = "white",
          size = 2,
          alpha = 0.5) + 
...
```{r,  warning=FALSE, message = FALSE}
mapview::mapview(bigfoot_summary_df, zcol = "number_of_sightings", at = seq(0, 70, 10), legend = TRUE, 
                 layer.name = "Total Number of Bigfoot Sightings by County (1869-2023)",
