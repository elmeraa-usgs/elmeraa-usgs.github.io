...
-   the palmetto data can be found in the *data* folder of [this repo](https://github.com/elmeraa/244-assignment2); the Rmd and html files, denoted as *a2-task2*, can be found in the *src* folder
